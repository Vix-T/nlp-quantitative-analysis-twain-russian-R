...
```{r}
# Visualize PCA results with color
# Define labels and colors for the documents
labels <- files
colors <- c("red", "blue", "green", "black", "orange")

# Visualize PCA results with stopwords
fviz_pca_ind(results_with_stopwords$pca,
             geom.ind = "point",
             title = "PCA of Texts with Stopwords",
             repel = TRUE,
             col.ind = labels, # Use document labels as color
             palette = colors) + # Use colors defined above
  theme_minimal()

# Visualize PCA results without stopwords
fviz_pca_ind(results_without_stopwords$pca, 
             geom.ind = "point",
             title = "PCA of Texts without Stopwords",
             repel = TRUE,
